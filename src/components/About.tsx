    ...
    <section id="about" className="bg-primary py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-lg text-light/80 space-y-6">
          <p>
            I'm an EECS student at Stanford interested in ML systems. Right now, I'm an AI/ML Research Intern at AMD, getting hands-on with GPU optimization. My main focus is on making large language models run more efficiently, which involves a lot of work with low-level kernel performance and memory access patterns.
          </p>
          <p>
